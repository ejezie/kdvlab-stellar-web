          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-kdv-light/80 mb-8">
                ...
                or are interested in joining our team, we'd love to hear from you. Fill out the form, 
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-kdv-blue">info@kdvlab.com</p>
                </div>
                
                <div>
                  <h3 className="text-xl font-semibold mb-2">Location</h3>
                  <p className="text-kdv-light/80">San Francisco, California</p>
                </div>
                
                <div>
                  <h3 className="text-xl font-semibold mb-2">Follow Us</h3>
                  <div className="flex space-x-4">
                    <a href="#" className="text-kdv-light hover:text-kdv-blue transition-colors">
